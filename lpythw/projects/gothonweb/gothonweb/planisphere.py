...
central_corridor = Room("Central Corridor",
                        ...
                        mission is to get the neutron destruct bomb from the Weapon 
                        it in the bridge, and blow the ship up after getting into army.
                        You're running down the central corridor to the Weapons Army.
